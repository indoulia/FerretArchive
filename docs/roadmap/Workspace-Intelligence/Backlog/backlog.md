...
- [ ] **WIP-022** Pinning (`pinnedStateHash`) resolution and fail-closed behavior — `03-Cross-Workspace-References.md` §3 — Workspace State Fingerprint defined via ADR-0027 amendment (2026-07-05), `13-Storage.md` §4 — ready for implementation.
